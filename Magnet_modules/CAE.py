...
if f_Nmbr > 0:
    from Inputs import f_l, f_I, f_operator, f_center
...
if s_Nmbr > 0:
    from Inputs import s_ver_org, s_J, s_operator, s_center
...
if a_Nmbr > 0:
    from Inputs import a_a0, a_phy_1, a_phy_2, a_I, a_operator, a_cnt_cart
...
if ra_Nmbr > 0:
    from Inputs import ra_r_inner, ra_r_outer, ra_phy_1, ra_phy_2, ra_tckns, ra_J, ra_operator, ra_cnt_cart
...
if cy_Nmbr > 0:
    from Inputs import cy_Nmbr, cy_ro, cy_l, cy_J, cy_operator, cy_center
...
if Hl_Nmbr > 0:
    from Inputs import Hl_a, Hl_L, Hl_p, Hl_I, Hl_operator, Hl_center
...
outPath = Path + '/Outputs/MAG_DATA.xlsx'

output_data.to_excel(outPath, index= False, sheet_name='Mag_field')
